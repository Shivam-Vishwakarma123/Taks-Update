...
<body>
  ...
  <header>
    ...
    <div id="sidenav-1" class="sidenav" role="navigation" data-hidden="false" data-accordion="true">
      <h2><a class="ripple d-flex justify-content-center py-4" href="/users" data-ripple-color="primary">Todo App</a></h2>

      <ul class="sidenav-menu">
        <li class="sidenav-item">
          <a class="sidenav-link" href="/users">
            <i class="fas fa-chart-area pr-3"></i><span>Users</span></a>
        </li>
        <li class="sidenav-item">
          <a class="sidenav-link"><i class="fas fa-cogs pr-3"></i><span>Send Mail</span></a>
          <ul class="sidenav-collapse">
            <li class="sidenav-item">
              <a class="sidenav-link">Last 10 Email</a>
            </li>
            <li class="sidenav-item">
    ...
    <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
      <div class="container-fluid">
        ...
        <ul class="navbar-nav ml-auto d-flex flex-row">
          <p class="me-5 mt-2 text-dark font-weight-bold"><?= strtoupper(session()->get('admin_name')) ?></p>
